...
def load_questions(question_file: str, begin: Optional[int], end: Optional[int]):
    ...
    return questions
question_list = load_questions('/home/xujiaming/xujiaming/train_machine/PJY/ISCA/ASPLOS-24/EAGLE/eagle/data/mt_bench/question.jsonl',begin=0,end=80)
...
print('tokens per second :  ',output_ids_tot/(ed-st))
...
# np.save('exit_layer_id_list.npy',exit_layer_id_list,)
# 24.36
