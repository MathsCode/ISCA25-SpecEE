...
top_k=4
# from model_llama_ee import LlamaDecoderLayer
...
class Model(nn.Module):
    ...
    def _prepare_decoder_attention_mask(self, attention_mask, batch_size,seq_length, inputs_embeds, past_key_values_length):
        # create causal mask
    ...
    def topK_genrate(self, hidden_states, input_ids, head):
        ...
        # [xjm:] add head weight
        top_head_weight = head.weight[topk_index].squeeze(0)
        return topk_index, topk_prob, top_head_weight
